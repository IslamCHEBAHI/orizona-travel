...
export default function PromotionPhotoUpload() {
  ...
  return (
    <div className="admin-photo-upload">
      ...
      <label className="admin-upload-box">
        ...
        <strong>
          Ajouter les photos de la promotion
        </strong>
        ...
        <small>
          JPG, PNG ou WEBP — maximum 8 photos — 8 Mo par photo
        </small>
      ...
      {previews.length > 0 && (
        ...
        <div className="admin-selected-images">
          ...
          <p className="admin-photo-note">
            La première photo sera utilisée comme image principale de la promotion.
          </p>
